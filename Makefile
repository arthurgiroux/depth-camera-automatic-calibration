...
all: tracking gridcalibration computecalibration

tracking:
	$(CC) $(CFLAGS) $(LDFLAGS)  -o bin/tracking src/tracking.cpp

gridcalibration:
	$(CC) $(CFLAGS) $(LDFLAGS)  -o bin/gridcalibration src/gridcalibration.cpp

computecalibration:
	$(CC) $(CFLAGS) $(LDFLAGS)  -o bin/computecalibration src/computecalibration.cpp
