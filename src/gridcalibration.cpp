...
/*
    Based on : http://docs.opencv.org/doc/tutorials/calib3d/camera_calibration/camera_calibration.html
*/
...
int main(int argc, char* argv[])
{
    ...
    createTrackbar("position", "playback controls", 0, floor(s.inputCapture.get(CV_CAP_PROP_FRAME_COUNT) / s.inputCapture.get(CV_CAP_PROP_FPS)), OnChangePosition, (void*) &s.inputCapture);
